require ${GUACABASE}/meta/recipes-core/glib-2.0/glib.inc
...
SRC_URI_append_virtclass-native = " file://${GUACABASE}/meta/recipes-core/glib-2.0/glib-2.0/glib-gettextize-dir.patch"
