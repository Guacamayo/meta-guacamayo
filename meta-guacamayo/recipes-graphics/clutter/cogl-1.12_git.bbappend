...
SRC_URI_append_beaglebone += "file://beagleboard-glchar.patch"

# X11 specifics
X11_DEPENDS             = "${STDDEPENDS} ${STDDEPENDS_X11} ${STDDEPENDS_GL}"
X11_DEPENDS_beagleboard = "${STDDEPENDS} ${STDDEPENDS_X11} ${STDDEPENDS_EGL}"
X11_DEPENDS_beaglebone  = "${STDDEPENDS} ${STDDEPENDS_X11} ${STDDEPENDS_EGL}"
...
X11_RDEPENDS_beaglebone  += "${STDRDEPENDS} ${STDRDEPENDS_GLES2}"
...
X11_EXTRA_OECONF_beaglebone  = "${BASE_CONF} ${BASE_CONF_X11_GLES}"
...
EGL_DEPENDS_beaglebone  = "${STDDEPENDS} ${STDDEPENDS_EGL} ${STDDEPENDS_GLES2}"
...
EGL_RDEPENDS_beaglebone  += "${STDRDEPENDS} ${STDRDEPENDS_GLES2}"
...
EGL_EXTRA_OECONF_beaglebone  = "${BASE_CONF} ${BASE_CONF_EGL_GLES}"
