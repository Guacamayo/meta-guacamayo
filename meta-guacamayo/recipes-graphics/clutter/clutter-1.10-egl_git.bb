...
STDDEPENDS = "gtk-doc-native pango glib-2.0 json-glib cogl-1.10-egl atk udev libxkbcommon"
DEPENDS = "${STDDEPENDS} virtual/egl"

CONFLICTS = "clutter-1.8 clutter-1.10-x11"
...
EXTRA_OECONF = "${BASE_CONF} --enable-egl-backend --disable-quartz-backend --disable-win32-backend --disable-x11-backend --disable-gdk-backend --disable-wayland-backend --disable-wayland-compositor --disable-cex100-backend --disable-tslib-input --enable-evdev-input"
